<div class="col-md-12 mt1 mb1">
    <div class="row">
        <a href="javascript:void(0)" id="new_subject" class="btn btn-maroon float-right">
    ...
    <div class="row">
        <div class="card col-md-12 shadow-lg border-0 rounded-lg">
            <div class="card-body">
                ...
                <table class="table table-bordered table-hover table-striped" width="100%" id="subject-field">
                ...
                if (resp) {
                    if (typeof resp != undefined) {
                        ...
                        Object.keys(resp).map(k => {
                            ...
                            var tr = $('<tr>')
                            tr.append('<td>' + i + '</td>')
                            tr.append('<td class="text-maroon fw-bold">' + resp[k].subject + '</td>')
                            tr.append('<td class="text-maroon">' + resp[k].description + '</td>')
                            tr.append(
                                '<td class="text-center">' +
                                '<button type="button" class="btn btn-gold btn-circle edit_subject mr-2" data-id="' + resp[k].id + '"><i class="fa fa-edit"></i></button>' +
                                '<button type="button" class="btn btn-maroon btn-circle remove_subject" data-id="' + resp[k].id + '"><i class="fa fa-trash"></i></button>' +
                                '</td>'
                            )
